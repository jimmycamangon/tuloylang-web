            ...
            <section className="flex flex-col items-center justify-center min-h-screen">
                <div className="flex flex-col md:flex-row w-full max-w-6xl items-center justify-between px-6 gap-10">
                    ...
                    <div className="flex flex-col p-4 pb-10 md:pb-24 text-center md:text-left">
                        ...
                        <small className="pb-2 text-gray-600">✔ Habit Tracking</small>
                        <small className="pb-2 text-gray-600">✔ Streak System</small>
                        <small className="pb-2 text-gray-600">✔ Workout Logs</small>
                        <small className="pb-2 text-gray-600">✔ Progress Analytics</small>
                    </div>
                ...
                {/* PREVIEW SECTION */}
                <div className="flex flex-col md:flex-row w-full max-w-6xl items-start px-6 gap-6">

                    <h1 className="text-2xl md:text-4xl font-black leading-tight shrink-0">
                        Preview
                    </h1>
